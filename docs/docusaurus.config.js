...
const config = {
  ...
  url: 'https://crypto-price-tracker-docs.netlify.app',
  ...
  organizationName: 'crypto-price-tracker', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/your-username/crypto-price-tracker/tree/main/docs/',
        },
        theme: {
